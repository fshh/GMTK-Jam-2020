...
public class Window : MonoBehaviour, IPointerClickHandler
{
    ...
    public GameObject UnFullscreenButton;
    ...
    public void Initialize(ApplicationSO app)
    {
        ...
        AppIcon.sprite = App.WindowIcon;
        ContentBackground.color = App.BackgroundColor;
    ...
    public void Fullscreen()
    {
        ...
        UnFullscreenButton.SetActive(true);
    ...
    public void UnFullscreen()
    {
        ...
        UnFullscreenButton.SetActive(false);
